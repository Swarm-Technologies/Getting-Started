...
class WSGIServer:
    ...
    def start(self):
        ...
        HOST = repr((wifi.radio.ipv4_address, wifi.radio.ipv4_address_ap)[wifi.radio.ipv4_address == None])
        self._server_sock.bind((repr((wifi.radio.ipv4_address, wifi.radio.ipv4_address_ap)[wifi.radio.ipv4_address == None]), self.port))
...
#             )
    ...
    def pretty_ip(self):
        return f"http://{(wifi.radio.ipv4_address, wifi.radio.ipv4_address_ap)[wifi.radio.ipv4_address == None]}:{self.port}"
    ...
    def update_poll(self):
        ...
        if self._client_sock:
            try:
                ...
                print("BAD!")
                self._response_status = "400 Bad Request"
                result = ""
    ...
    def _get_environ(self, client):
        ...
        env["SCRIPT_NAME"] = ""
        env["SERVER_NAME"] = str((wifi.radio.ipv4_address, wifi.radio.ipv4_address_ap)[wifi.radio.ipv4_address == None])
