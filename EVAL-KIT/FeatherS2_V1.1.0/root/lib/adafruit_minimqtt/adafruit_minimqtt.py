...
# NOTE: This is MODIFIED to fix some issues.
#
# See: poll() issue https://github.com/adafruit/Adafruit_CircuitPython_MiniMQTT/issues/86
#
#
    ...
    def _get_connect_socket(self, host, port, *, timeout=1):
        ...
        while retry_count < 5 and sock is None:
            ...
            try:
                ...
                self.logger.debug("- memory error")
                sock.close()
                sock = None
            except OSError:
